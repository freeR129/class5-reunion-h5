...
export default function Home() {
  ...
  const startTimelineWarmup=()=>{if(timelineWarmupStartedRef.current)return;timelineWarmupStartedRef.current=true;timelineWarmupTimerRef.current=window.setTimeout(()=>{console.debug('[media] timeline warmup start: first two nodes');enqueueTimelineImages([0,1],'high')},20)};
